          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-2xl p-6">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">🚀 Get Early Access</h4>
                <p className="text-gray-600 mb-4">Join our exclusive WhatsApp group for early access, beta testing, and direct feedback with our team.</p>
                <a 
                  href="https://chat.whatsapp.com/KQLaXNhJKEu2w0KqtEP5Cs"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center w-full bg-green-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-600 transition-all duration-300 transform hover:scale-105"
                >
                ...
                <p className="text-green-600 text-sm mt-2 font-medium">
                  ✨ Instant access • Beta features • Direct support
                </p>
              </div>

              {/* Email Waitlist Option */}
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 border border-purple-200 rounded-2xl p-6">
                <div className="flex items-center justify-center mb-4">
                  <div className="bg-gradient-to-r from-pulse-500 to-purple-600 rounded-full p-3">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">📧 Join Waitlist</h4>
                <p className="text-gray-600 mb-4">Get notified when Step Genie launches with exclusive early-bird pricing and bonuses.</p>
                ...
                <div className="space-y-3">
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-pulse-500 focus:border-transparent outline-none text-gray-900 placeholder-gray-500"
                  ...
                  <button
                    ...
                    disabled={isSubmitting}
                    className="w-full bg-gradient-to-r from-pulse-500 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  >
                ...
                <p className="text-purple-600 text-sm mt-2 font-medium">
                  🎁 Early-bird pricing • Launch bonuses • No spam
                </p>
              </div>
            </div>
            
            <p className="text-gray-500 text-sm">
              Choose your preferred way to stay updated with Step Genie
            </p>
          </div>
        </div>
      </div>
